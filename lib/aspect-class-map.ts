// Aspect class mapping - synced from the Discord bot's data/aspect_class_map.json
export const aspectClassMap: { [className: string]: string[] } = {
  "mage": [
    ...
    "Aspect of the Forbidden Ritual",
    "Aspect of the Indescribable",
    "Aspect of the Inescapable Void",
    "Aspect of Limitless Knowledge",
    "Aspect of Indoctrination",
    "Aspect of the Vast Emptiness",
    "Riftwalker's Embodiment of Chronal Control",
    "Riftwalker's Embodiment of Reality Alteration",
    "Light Bender's Embodiment of Celestial Brilliance",
    "Arcanist's Embodiment of Total Obliteration",
    "Mage's Embodiment of Morbid Curiosity"
  ],
  "archer": [
    ...
    "Archer's Embodiment of Perceptive Finesse"
  ],
  "warrior": [
    ...
    "Aspect of the Enforcer",
    "Aspect of the Humming Choir",
    "Aspect of the Crimson Scrivener",
    "Aspect of the Golden Dawn",
    ...
    "Warrior's Embodiment of Everlasting Perseverance"
  ],
  "assassin": [
    ...
    "Aspect of the Pernicious Prankster",
    "Aspect of Seeking Stars",
    "Aspect of Sleight-Of-Hand",
    "Aspect of the Unstoppable Force",
    "Aspect of Unyielding Fate",
    "Aspect of Visual Distortion",
    "Shadestepper's Embodiment of Unseen Execution",
    "Trickster's Embodiment of Malevolent Mischief",
    "Acrobat's Embodiment of Gravity Defiance",
    "Assassin's Embodiment of Otherworldly Detachment"
  ],
  "shaman": [
    ...
    "Aspect of Stances",
    "Aspect of the Artisan",
    "Aspect of the Blurred Line",
    ...
    "Shaman's Embodiment of Serene Harmony"
  ]
};
