...
export const EXEC_NAV: ExecNavGroup[] = [
  ...
  },
  {
    category: 'Economy',
    items: [
      { href: '/exec/inventory', label: 'Inventory', desc: 'Track ingredient, consumable, and material stock', icon: 'M20 7l-8-4-8 4m16 0-8 4m8-4v10l-8 4m0-10L4 7m8 4v10m-8-14v10l8 4' },
