...
const FRUMA_LOCATIONS: Record<string, { start: [number, number]; end: [number, number] }> = {
  ...
  "Residence Sector":       { start: [-1966, -932],  end: [-1805, -752]  },
  ...
  "Gates to Aelumia":       { start: [-1624, -1003], end: [-1471, -834]  },
  ...
  "The Lumbermill":         { start: [-1905, -1094], end: [-1806, -932]  },
  ...
  "Verdant Grove":          { start: [-1471, -727],  end: [-1360, -646]  },
  "Aldwell":                { start: [-1356, -758],  end: [-1202, -646]  },
  "Timasca":                { start: [-1856, -712],  end: [-1631, -398]  },
  "Fort Hegea":             { start: [-1194, -791],  end: [-1054, -579]  },
  "Fort Tericen":           { start: [-1330, -1160], end: [-1178, -948]  },
  "Fort Torann":            { start: [-2020, -1725], end: [-1825, -1550] },
