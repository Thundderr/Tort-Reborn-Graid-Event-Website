---
id: wynncraft-wiki-gg-wiki-guilds
url: https://wynncraft.wiki.gg/wiki/Guilds
kind: wiki
title: "Guilds - Official Wynncraft Wiki"
fetched_at: 2026-09-04T10:24:27.681Z
...
Guilds are generally a group of people who work together to achieve a long-term goal. Some guilds mainly focus on war, and others focus on building a community. Warring is an activity exclusively restricted to guilds, and is done by guilds to control territories or land on the map. You can level up your guild by giving it some of the XP that you earn by using the /guild xp [int] command, doing raids with guild members and enabling the Guild Raid opt in, or by taking territories and leveling up the "XP Seeking" bonus. Your guild can start with a maximum of 5 members, and will increase as you level it up (see the perks table below) up to a maximum of 150 guild members. Each territory you own will allow you to use bonuses to get things like guild xp, guild emeralds, guild resources (more on this later) as well as bonuses to allow you to generate emeralds & tomes you can give to players.
[image: Guilds wynn.png]
...
When creating a guild, you may choose both the name and the tag that your guild will use.
The guild name and tag must meet the following requirements:
...
Wars are one of the main activities you can do in a guild. It is the main source of Guild tomes , as well as providing boosts to members inside territories.
It consists of a territory capture game across the map of Wynncraft, where you capture territories by participating in wars against a Guild Tower boss, for benefits such as Emeralds, XP, Guild Tomes and Season Rating
...
[image: Example error message of being unable to war]
...
Guilds members can contribute experience to the guild using the /gu xp <0-100> . There are other ways for guilds to gain XP, mainly XP seeking upgrades on territories and Guild Raids When a guild levels up, it receives the perk corresponding to that level. The amount required for each level can be calculated using the following formula:

experience = base * ∑ n = 1 level 1 . 1 5 n − 1

Each variable represents the following:

- experience : Experience required to level up from the current level (from level minimum).

- base : Base amount of experience required (Defaults to 20,000).

- level : Current level of the guild.

- n : Iterator value for levels 1 to level .
...
Weekly Guild Objectives Unlocked
...
There is no guild level limit, but xp stops scaling at level 130
...
Talk globally to your guild members in the guild chat.

/guild leaderboard

See the global guild leaderboard (also available on the website ).

/guild list

See every member in your guild and some basic info about them such as their xp contributed.

/guild stats

See the global guild statistics (also available on the website ).

/guild log

See the latest guild logs.

/guild xp [amount]

Specify how much percentage of your gained Combat XP will go towards leveling up your guild. This includes all Combat XP from quests, mini-quests, and mobs.
...
Open the guild management menu with more permissions
...
/guild rank [name] [rank]

Rank up or down a member of the guild (only below your own rank).

/guild attack

Attack the territory you're standing at.
...
Kick members from the guild (only below your own rank)

/guild banner

Open the banner editor (flag upgrading is currently broken)
...
Permanently disbands the guild

/guild seticon

Sets the guild icon (to hand)
...
[image: /images/Guild_Banner_Tier_1.png?927a74]
Tier 1 banner
...
[image: /images/Guild_Banner_Tier_2.png?6e4c76]
Tier 2 banner
...
[image: /images/thumb/Guild_Banner_Tier_3.png/200px-Guild_Banner_Tier_3.png?1d393d]
Tier 3 banner
...
[image: /images/thumb/Guild_Banner_Tier_4.png/200px-Guild_Banner_Tier_4.png?50da5e]
Tier 4 banner
...
[image: /images/thumb/Guild_Banner_Tier_5.png/200px-Guild_Banner_Tier_5.png?3f3a65]
Tier 5 banner
...
[image: /images/thumb/Guild_Banner_Tier_6.png/200px-Guild_Banner_Tier_6.png?3a9502]
Tier 6 banner
...
[image: /images/thumb/Lvl7Banner.png/200px-Lvl7Banner.png?d8e79e]
Tier 7 banner
...
[image: /images/thumb/Lvl8Banner.png/200px-Lvl8Banner.png?b83d23]
Tier 8 banner
...
G Raid, graid
Raids done with the Guild Raid option, which give rewards to the guild and the raiders, but can only be done with guild members.
HR (bank)
High rank guild bank, only accessible to the guild owner, chiefs and sometimes strategists.
LR (bank)
Low rank bank, available to low rank players.
G housing, ghouse
Abbreviation for the guild housing.
SR
Abbreviation for season rating.
Trivia
...
Retrieved from " https://wynncraft.wiki.gg/wiki/Guilds?oldid=151030 "
