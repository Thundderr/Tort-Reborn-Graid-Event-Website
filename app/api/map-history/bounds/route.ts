...
// v2: gaps exclude known war-outage windows (lib/war-outages.ts)
// v3: gap boundaries are precise exchange timestamps, not day-granular
const META_KEY = 'map-history-bounds-meta-v3';
