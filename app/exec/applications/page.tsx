        ...
        {([
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '0.5rem',
              border: '1px solid',
              borderColor: appTab === tab.value ? (tab.value === 'hammerhead' ? '#04b0eb' : 'var(--color-ocean-500)') : 'var(--border-card)',
              background: appTab === tab.value ? (tab.value === 'hammerhead' ? '#04b0eb' : 'var(--color-ocean-500)') : 'transparent',
                  ...
                  {filters.map(f => (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: '0.375rem',
                        border: '1px solid',
                        borderColor: hhStatusFilter === f.value ? '#04b0eb' : 'var(--border-card)',
                        background: hhStatusFilter === f.value ? '#04b0eb' : 'transparent',
