...
export default function ExecGuildRaidsPage() {
  ...
  if (meta.loading) {
    return (
      <div>
        <h1 style={{ fontSize: '1.75rem', fontWeight: '800', color: 'var(--text-primary)', marginBottom: '2rem' }}>Guild Raids</h1>
  ...
  return (
    <div>
      <h1 style={{ fontSize: '1.75rem', fontWeight: '800', color: 'var(--text-primary)', marginBottom: '1.5rem' }}>Guild Raids</h1>
